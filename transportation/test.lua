...
function tu.getDirection( from, to, parts, adj )
    ...
    mw.log('latDiff: ' .. latDiff)
    mw.log('longDiff: ' .. longDiff)
    ...
    for i = 1, parts do
        ...
        mw.log('fromAngle: ' .. fromAngle / math.pi)
        mw.log('toAngle: ' .. toAngle / math.pi)
        mw.log('coordAngle: ' .. coordAngle / math.pi)
        mw.log('adjAngle: ' .. adjAngle / math.pi)
        mw.log('targetAngle: ' .. targetAngle / math.pi)
...
for _, v in pairs(Yama.stations) do mw.log(v:getName()) end
mw.logObject(Yama.entity)
mw.log(tu.getDirection({ 37.789222, -122.40341 }, { 37.822061829026204, -122.40442574618967 } ))
